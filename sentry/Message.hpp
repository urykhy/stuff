...
namespace Sentry {
    ...
    public:
        ...
        Message& set_environment(const std::string& v)
        {
            m_Root["environment"] = v;
            return *this;
        }
        Message& set_transaction(const std::string& v)
        {
            m_Root["transaction"] = v;
            return *this;
        }

        Message& set_message(const std::string& v)
        {
        ...
        Message& set_tag(const std::string& aName, const std::string& aValue)
        {
            m_Root["tags"][aName] = aValue;
            return *this;
        }
        Message& set_extra(const std::string& aName, const std::string& aValue)
        {
            m_Root["extra"][aName] = aValue;
            return *this;
        }
        ...
        Message& set_release(const std::string& v)
        {
            m_Root["release"] = v;
            return *this;
        }
        Message& set_distrib(const std::string& v)
        {
            m_Root["dist"] = v;
            return *this;
        }
